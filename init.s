...
.LM20:
	movl	$6581362, 4(%rsp)
	.stabn	68,0,38,.LM21-.LFBB2
.LM21:
	call	cprintf@PLT
	.stabn	68,0,40,.LM22-.LFBB2
.LM22:
	movl	$5, %edi
	call	test_backtrace
	.p2align 4,,10
...
.LFB2:
	...
	movaps	%xmm7, 192(%rsp)
.L11:
	.stabn	68,0,60,.LM25-.LFBB3
.LM25:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,63,.LM26-.LFBB3
.LM26:
	cmpq	$0, panicstr(%rip)
	je	.L16
	.p2align 4,,10
...
.LM27:
	...
	jmp	.L13
.L16:
	.stabn	68,0,65,.LM28-.LFBB3
.LM28:
	movq	%rbp, panicstr(%rip)
	.stabn	68,0,68,.LM29-.LFBB3
.LM29:
#APP
# 68 "kern/init.c" 1
	cli; cld
...
.LM33:
	leaq	.LC4(%rip), %rdi
	.stabn	68,0,70,.LM34-.LFBB3
.LM34:
	movq	%rax, 16(%rsp)
	.stabn	68,0,71,.LM35-.LFBB3
.LM35:
	xorl	%eax, %eax
	.stabn	68,0,70,.LM36-.LFBB3
.LM36:
	movl	$48, 4(%rsp)
	.stabn	68,0,71,.LM37-.LFBB3
.LM37:
	call	cprintf@PLT
	.stabn	68,0,72,.LM38-.LFBB3
.LM38:
	movq	%rbp, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,73,.LM39-.LFBB3
.LM39:
	leaq	.LC5(%rip), %rdi
	xorl	%eax, %eax
	call	cprintf@PLT
...
.LFB3:
	...
	movaps	%xmm7, 192(%rsp)
.L18:
	.stabn	68,0,85,.LM41-.LFBB4
.LM41:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,88,.LM42-.LFBB4
.LM42:
	leaq	224(%rsp), %rax
	.stabn	68,0,89,.LM43-.LFBB4
.LM43:
	movq	%r10, %rsi
	movl	%r11d, %edx
	.stabn	68,0,88,.LM44-.LFBB4
.LM44:
	movq	%rax, 8(%rsp)
	leaq	32(%rsp), %rax
	.stabn	68,0,89,.LM45-.LFBB4
.LM45:
	leaq	.LC6(%rip), %rdi
...
.LM47:
	xorl	%eax, %eax
	.stabn	68,0,88,.LM48-.LFBB4
.LM48:
	movl	$24, (%rsp)
	movl	$48, 4(%rsp)
	.stabn	68,0,89,.LM49-.LFBB4
.LM49:
	call	cprintf@PLT
	.stabn	68,0,90,.LM50-.LFBB4
.LM50:
	movq	%rsp, %rsi
	movq	%rbp, %rdi
	call	vcprintf@PLT
	.stabn	68,0,91,.LM51-.LFBB4
.LM51:
	xorl	%eax, %eax
	leaq	.LC5(%rip), %rdi
	call	cprintf@PLT
	.stabn	68,0,93,.LM52-.LFBB4
.LM52:
	movq	24(%rsp), %rax
	xorq	%fs:40, %rax
	jne	.L21
